  ...
  return (
    <Flex height='100vh' width='full' justifyContent='center' align='center' flexDirection='column'>
      <Box
        ...
        {isSent ? (
          <>
            <Text data-testid='sent-message' fontSize='sm' fontWeight='semibold'>
          ...
          <>
            <Text fontSize='2xl' fontWeight='semibold' marginTop='2'>
            ...
            {isAlert ? (
              <Box marginTop='2'>
                <Alert data-testid='error' status='error'>
                  <AlertIcon />
                  <AlertTitle data-testid='error-message' mr={2}>
                    {alertMess}
                  </AlertTitle>
                  <CloseButton
                    marginLeft='1'
