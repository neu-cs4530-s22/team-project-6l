...
*/
@ObjectType({ description: 'If no errors, returns the user. Otherwise, return the error alongside null for user' })
export default class UserResponse {
  ...
  @Field(() => User, { description: 'The resulting user if no errors were returned', nullable: true })
  user?: User;
}